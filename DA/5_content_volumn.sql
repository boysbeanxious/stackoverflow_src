...
from
	...
	select
		...
		cast(creationdate as date) as cdate, 
		case
        when cast(deletiondate as date) <= '2024-10-01'
			then 1
			else 0
		end as del_yn,
		case
	...
	from
		postswithdeleted
	where
		-- treat_0_1_condition1_1.csv
		--cast(creationdate as date) between '2021-10-06' and '2021-12-31'
		-- treat_0_2_condition1_1.csv
		--cast(creationdate as date) between '2022-01-01' and '2022-03-15'
		-- treat_1_1_condition1_1.csv
		--cast(creationdate as date) between '2022-10-05' and '2022-12-31'
		-- treat_1_2_condition1_1.csv
		cast(creationdate as date) between '2023-01-01' and '2023-03-14'
		and posttypeid = '1'
		--and deletiondate <= '2023-12-03'
   and (tags like '%<python>%'
...
from
	...
	from
		...
		from
			...
			where
				-- posts_treat_0_1.csv
                 cast(creationdate as date) between '2021-10-06' and '2021-10-31'
				-- cast(creationdate as date) between '2021-10-06' and '2021-12-31'
				-- posts_treat_0_2.csv
				-- cast(creationdate as date) between '2022-01-01' and '2022-03-15'
				-- posts_treat_1_1.csv
	...
	from
		...
		from
			...
			from
				postswithdeleted
			where
				-- posts_treat_0_202110.csv
                -- cast(creationdate as date) between '2021-10-06' and '2021-10-31'
                -- posts_treat_0_202111.csv
                --cast(creationdate as date) between '2021-11-01' and '2021-11-30'
                -- posts_treat_0_202112.csv
				-- cast(creationdate as date) between '2021-12-01' and '2021-12-31'
                -- posts_treat_0_202201.csv
				-- cast(creationdate as date) between '2022-01-01' and '2022-01-31'
                -- posts_treat_0_202202.csv
                -- cast(creationdate as date) between '2022-02-01' and '2022-02-28'
                -- posts_treat_0_202203.csv
                 cast(creationdate as date) between '2022-03-01' and '2022-03-15'                
				and posttypeid = '1'
				and (tags like '%<python>%'
					or tags like '%<javascript>%'
					or tags like '%<reactjs>%'
...
select /*deletedQ_cond1*/
       x.cdate
     , count(id) as tot_q
     , sum(del_yn) as deleted_q
from (
  select id
       , cast(creationdate as date) as cdate
       , posttypeid
