    ...
    if chk_targ_yn(posttype, st_dt, end_dt, num_p) == False:
        ...
        try:
            for dt in dt_list : 
                ...
                first_ann_q_id = [[int(x), -1 ] for x in np.random.choice(dt_p_id_list, size=num_p, replace=False)]
                print("sample_insert > create connection> first_ann_q_id>", dt, first_ann_q_id)

                sql = 'INSERT INTO public.tt_posts_difficulty( id, difficulty_level  )  VALUES %s'
